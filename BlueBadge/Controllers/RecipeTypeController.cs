...
namespace BlueBadge.Controllers
{
    public class RecipeTypeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RecipeKind,TypeName,Dietary")] RecipeType recipeType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RecipeKind,TypeName,Dietary")] RecipeType recipeType)
        {
            if (ModelState.IsValid)
            {
