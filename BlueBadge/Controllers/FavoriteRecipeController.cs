...
namespace BlueBadge.Controllers
{
    public class FavoriteRecipeController : Controller
    {
        ...
        {
            return View(db.FavoriteRecipe.ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            FavoriteRecipe favoriteRecipe = db.FavoriteRecipe.Find(id);
        ...
        public ActionResult Create([Bind(Include = "FavoriteRecipeID,UserID,RecipeID")] FavoriteRecipe favoriteRecipe)
        {
            ...
            {
                db.FavoriteRecipe.Add(favoriteRecipe);
                db.SaveChanges();
        ...
        {
            FavoriteRecipe favoriteRecipe = db.FavoriteRecipe.Find(id);
            db.FavoriteRecipe.Remove(favoriteRecipe);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
